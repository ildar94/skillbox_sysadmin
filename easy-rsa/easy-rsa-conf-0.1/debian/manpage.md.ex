% easy-rsa-conf(SECTION) | User Commands
%
% "August  3 2023"
...
easy-rsa-conf - program to do something

# SYNOPSIS

**easy-rsa-conf** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**easy-rsa-conf** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **easy-rsa-conf** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**easy-rsa-conf** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    easy-rsa-conf. See **foo.conf**(5) for further details.
...
**easy-rsa-conf** provides some return codes, that can be used in scripts:
...
Ildar Gilyazev <i.gilyazev@gilyazev-devops.ru>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Ildar Gilyazev
